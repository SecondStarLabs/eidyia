...
class Scraper::Slicelife

    attr_reader :city, :state_abbr, :shop
    ...
    def _generate_url
        ...
        base_url                    = 'https://slicelife.com/shop/search'
        search_shipping_type_filter = "either"
        address                     = "#{city}, #{state_abbr}, USA".gsub(" ","%20")
